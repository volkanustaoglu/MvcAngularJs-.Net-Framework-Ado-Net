...
(function (window, document) {
    ...
    angular.module('toaster', []).constant(
        ...
        $templateCache.put('angularjs-toaster/toast.html',
            ...
            '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type" onclick=""; ng-click="click($event, toaster)" ng-mouseover="stopTimer(toaster)" ng-mouseout="restartTimer(toaster)">' +
